 ...
 *
 * @note (1) Beyond Int.MAX_VALUE elements, countOccurrences, size, and grab are
 *       wrong.
 *       <p>
 *       (2) Because of the slow linear algorithms of this class, large bags
 *       will have poor performance.
 *
 * @see <A HREF="../../../../edu/colorado/collections/LinkedBag.java"> Java
 *      Source Code for this class
 *      (www.cs.colorado.edu/~main/edu/colorado/collections/LinkedBag.java) </A>
 *
...
public class LinkedBag<E> implements Cloneable {
	...
	/**
	 * Put a reference to an object into this bag. The new element may be the null
	 * reference.
	 * 
	 * @param element
	 *            the new element to be added to this bag
	 * @postcondition The element has been added to this bag.
	 ...
	 *         return value must be type cast to an LinkedBag before it can be used.
	 * @exception OutOfMemoryError
	 *                Indicates insufficient memory for creating the clone.
	 **/
	@SuppressWarnings("unchecked")
	public LinkedBag<E> clone() { // Clone a LinkedBag object.
		LinkedBag<E> answer;
	 ...
	 * @return The return value is the number of times that target occurs in this
	 *         bag. If target is non-null, then the occurrences are found using the
	...
	public int countOccurrences(E target) {
		...
		while (cursor != null) { // Each time that cursor is not null, we have another occurrence of
	 ...
	 * 
	 * @precondition This bag is not empty.
	 ...
	 * 
	 * @return an Iterator containing the elements of this bag. <b>Note</b> If
	 *         changes are made to this bag before the Iterator returns all of its
	 *         elements, then the subsequent behavior of the Iterator is
	 *         unspecified.
	 **/
	...
	public boolean remove(E target) {
		...
		if (targetNode == null)
			...
			return false;
		else { // The target was found at targetNode. So copy the head data to targetNode
