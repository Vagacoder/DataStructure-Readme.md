...
/******************************************************************************
 * A <CODE>Table</CODE> is an open-address hash table with a fixed capacity. The
 * purpose is to show students how an open-address hash table is implemented.
 * Programs should generally use java.util.Hashtable rather than this hash
 * table.
 *
 * <b>Java Source Code for this class:</b>
 * <A HREF="../../../../edu/colorado/collections/Table.java">
 * http://www.cs.colorado.edu/~main/edu/colorado/collections/Table.java </A>
 *
...
public class Table {
	 ...
	 *            <b>Postcondition:</b> This table is empty and has the specified
	 *            capacity.
	 ...
	 * 
	 * @param key
	 *            the non-null key to look for <b>Precondition:</b> <CODE>key</CODE>
	 *            cannot be null.
	 * @return <CODE>true</CODE> (if this table contains an object with the
	 *         specified key); <CODE>false</CODE> otherwise. Note that
	 *         <CODE>key.equals( )</CODE> is used to compare the <CODE>key</CODE> to
	 *         the keys that are in the table.
	 ...
	 *            <b>Precondition:</b> If there is not already an element with the
	 *            specified <CODE>key</CODE>, then this table�s size must be less
	 *            than its capacity (i.e., <CODE>size() &lt; capacity()</CODE>).
	 *            Also, neither <CODE>key</CODE> nor <CODE>element</CODE> is null.
	 * @return If this table already has an object with the specified
	 *         <CODE>key</CODE>, then that object is replaced by
	 *         <CODE>element</CODE>, and the return value is a reference to the
	 *         replaced object. Otherwise, the new <CODE>element</CODE> is added
	 *         with the specified <CODE>key</CODE> and the return value is null.
	 ...
	 *         object has been removed from this table and a copy of the removed
	 *         object is returned; otherwise, this table is unchanged and the null
	 *         reference is returned. Note that <CODE>key.equals( )</CODE> is used
	 *         to compare the <CODE>key</CODE> to the keys that are in the table.
	 * @exception NullPointerException
	 *                Indicates that <CODE>key</CODE> is null.
	 **/
