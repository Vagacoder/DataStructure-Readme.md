...
/******************************************************************************
 * A <CODE>ChainedTable</CODE> is a chained hash table. The implementation isn't
 * given here since it is an assignment in a typical data structures class. In
 * general, programs should use java.util.HashTable rather than this
 * ChainedTable.
 *
...
public class ChainedTable {
	 ...
	 *            <b>Precondition:</b> <CODE>tableSize \&gt; 0</CODE>
	 *            <b>Postcondition:</b> This ChainedTable is empty and has the
	 ...
	 *         this ChainedTable contains an such an object); null otherwise. Note
	 *         that <CODE>key.equals( )</CODE> is used to compare the
	 *         <CODE>key</CODE> to the keys that are in the ChainedTable.
	 * @exception NullPointerException
	 *                Indicates that <CODE>key</CODE> is null.
	 **/
	 ...
	 *            <b>Precondition:</b> Neither <CODE>key</CODE> nor
	 *            <CODE>element</CODE> is null.
	 * @return If this ChainedTable already has an object with the specified
	...
	public Object put(Object key, Object element) {
		...
		if (containsKey(key)) {
			cursor = (ChainedHashNode) get(key);
		} else {
			cursor = null;
		}
	 ...
	 *         object has been removed from this ChainedTable and a copy of the
	 *         removed object is returned; otherwise, this ChainedTable is unchanged
	 *         and the null reference is returned. Note that
	 *         <CODE>key.equals( )</CODE> is used to compare the <CODE>key</CODE> to
	 *         the keys that are in the ChainedTable.
	 * @exception NullPointerException
	 *                Indicates that <CODE>key</CODE> is null.
